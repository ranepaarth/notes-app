...
const NotesSection = () => {
  ...
  return (
    <>
      <button
        type="button"
        className="bg-sky-950/30 p-2 border border-sky-950/30 rounded-full hover:shadow-lg hover:shadow-yellow-950 font-semibold text-sky-950 absolute bottom-10 right-10 text-3xl"
